...
static BOOL wf_create_file_obj(UINT32 *connID, wfClipboard *clipboard,
...
static UINT cliprdr_send_data_request(UINT32 connID, wfClipboard *clipboard,
                                      UINT32 format);
...
static UINT cliprdr_send_request_filecontents(wfClipboard *clipboard,
                                              ...
                                              UINT32 flag, DWORD positionhigh,
...
CliprdrStream_QueryInterface(IStream *This, REFIID riid, void **ppvObject) {
...
static HRESULT STDMETHODCALLTYPE
CliprdrStream_Seek(IStream *This, LARGE_INTEGER dlibMove, DWORD dwOrigin,
...
static HRESULT STDMETHODCALLTYPE
CliprdrStream_SetSize(IStream *This, ULARGE_INTEGER libNewSize) {
    (void)This;
    (void)libNewSize;
    return E_NOTIMPL;
}
...
static HRESULT STDMETHODCALLTYPE
CliprdrStream_CopyTo(IStream *This, IStream *pstm, ULARGE_INTEGER cb,
...
static HRESULT STDMETHODCALLTYPE
CliprdrStream_LockRegion(IStream *This, ULARGE_INTEGER libOffset,
...
static HRESULT STDMETHODCALLTYPE
CliprdrStream_UnlockRegion(IStream *This, ULARGE_INTEGER libOffset,
                           ULARGE_INTEGER cb, DWORD dwLockType) {
    (void)This;
    (void)libOffset;
    (void)cb;
...
static CliprdrStream *CliprdrStream_New(UINT32 connID, ULONG index, void *pData,
    ...
    if (instance) {
        ...
        if (iStream->lpVtbl) {
            ...
            if (((instance->m_Dsc.dwFlags & FD_FILESIZE) == 0) && !isDir) {
                ...
                if (cliprdr_send_request_filecontents(
                        clipboard, instance->m_connID, (void *)instance,
...
static HRESULT STDMETHODCALLTYPE CliprdrDataObject_GetData(
    ...
    if (instance->m_pFormatEtc[idx].cfFormat ==
        RegisterClipboardFormat(CFSTR_FILEDESCRIPTORW)) {
        // FILEGROUPDESCRIPTOR *dsc;
        FILEGROUPDESCRIPTORW *dsc;
        // DWORD remote_format_id = get_remote_format_id(clipboard,
            ...
            if (!instance->m_pStream) {
                ...
                if (instance->m_pStream) {
                    for (i = 0; i < instance->m_nStreams; i++) {
                        instance->m_pStream[i] = (IStream *)CliprdrStream_New(
                            instance->m_connID, i, clipboard, &dsc->fgd[i]);
        ...
        if ((pFormatEtc->lindex >= 0) &&
            ((ULONG)pFormatEtc->lindex < instance->m_nStreams)) {
...
static HRESULT STDMETHODCALLTYPE
CliprdrDataObject_QueryGetData(IDataObject *This, FORMATETC *pformatetc) {
    CliprdrDataObject *instance = (CliprdrDataObject *)This;
...
static HRESULT STDMETHODCALLTYPE
CliprdrDataObject_SetData(IDataObject *This, FORMATETC *pformatetc,
...
static HRESULT STDMETHODCALLTYPE
CliprdrDataObject_DAdvise(IDataObject *This, FORMATETC *pformatetc, DWORD advf,
...
static HRESULT STDMETHODCALLTYPE
CliprdrDataObject_DUnadvise(IDataObject *This, DWORD dwConnection) {
    (void)This;
    (void)dwConnection;
    return OLE_E_ADVISENOTSUPPORTED;
}
...
static HRESULT STDMETHODCALLTYPE
CliprdrDataObject_EnumDAdvise(IDataObject *This, IEnumSTATDATA **ppenumAdvise) {
    (void)This;
    (void)ppenumAdvise;
    return OLE_E_ADVISENOTSUPPORTED;
}

static CliprdrDataObject *CliprdrDataObject_New(UINT32 connID,
                                                FORMATETC *fmtetc,
                                                STGMEDIUM *stgmed, ULONG count,
                                                void *data) {
...
static BOOL wf_create_file_obj(UINT32 *connID, wfClipboard *clipboard,
    ...
    *ppDataObject = (IDataObject *)CliprdrDataObject_New(*connID, fmtetc,
                                                         stgmeds, 2, clipboard);
...
CliprdrEnumFORMATETC_AddRef(IEnumFORMATETC *This) {
...
static ULONG STDMETHODCALLTYPE
CliprdrEnumFORMATETC_Release(IEnumFORMATETC *This) {
    LONG count;
    CliprdrEnumFORMATETC *instance = (CliprdrEnumFORMATETC *)This;
...
static HRESULT STDMETHODCALLTYPE
CliprdrEnumFORMATETC_Reset(IEnumFORMATETC *This) {
    CliprdrEnumFORMATETC *instance = (CliprdrEnumFORMATETC *)This;
...
static HRESULT STDMETHODCALLTYPE
CliprdrEnumFORMATETC_Clone(IEnumFORMATETC *This, IEnumFORMATETC **ppEnum) {
    CliprdrEnumFORMATETC *instance = (CliprdrEnumFORMATETC *)This;

    if (!instance || !ppEnum)
        return E_INVALIDARG;

    *ppEnum = (IEnumFORMATETC *)CliprdrEnumFORMATETC_New(
        instance->m_nNumFormats, instance->m_pFormatEtc);
...
CliprdrEnumFORMATETC *CliprdrEnumFORMATETC_New(ULONG nFormats,
    ...
    iEnumFORMATETC->lpVtbl =
        (IEnumFORMATETCVtbl *)calloc(1, sizeof(IEnumFORMATETCVtbl));

    if (!iEnumFORMATETC->lpVtbl)
        goto error;

    iEnumFORMATETC->lpVtbl->QueryInterface =
    ...
    if (nFormats > 0) {
        instance->m_pFormatEtc =
            (FORMATETC *)calloc(nFormats, sizeof(FORMATETC));

        if (!instance->m_pFormatEtc)
            goto error;

        for (i = 0; i < nFormats; i++)
            cliprdr_format_deep_copy(&instance->m_pFormatEtc[i],
                                     &pFormatEtc[i]);
    }
...
static UINT32 get_local_format_id_by_name(wfClipboard *clipboard,
    ...
    MultiByteToWideChar(CP_OEMCP, 0, format_name, strlen(format_name),
                        unicode_name, size);
#endif
...
static BOOL file_transferring(wfClipboard *clipboard) {
    return get_local_format_id_by_name(clipboard, CFSTR_FILEDESCRIPTORW)
               ? TRUE
               : FALSE;
}
...
static UINT cliprdr_send_tempdir(wfClipboard *clipboard) {
    ...
    return clipboard->context->TempDirectory(clipboard->context,
                                             &tempDirectory);
}

static BOOL cliprdr_GetUpdatedClipboardFormats(wfClipboard *clipboard,
                                               PUINT lpuiFormats, UINT cFormats,
                                               PUINT pcFormatsOut) {
    UINT index = 0;
    UINT format = 0;
...
UINT wait_response_event(UINT32 connID, wfClipboard *clipboard, HANDLE event,
                         void **data) {
    UINT rc = ERROR_SUCCESS;
    clipboard->context->IsStopped = FALSE;
    DWORD waitOnceTimeoutMillis = 50;
    int waitCount = 1000 * clipboard->context->ResponseWaitTimeoutSecs /
                    waitOnceTimeoutMillis;
    int i = 0;
    for (; i < waitCount; i++) {
...
static UINT cliprdr_send_data_request(UINT32 connID, wfClipboard *clipboard,
    ...
    wait_response_event(connID, clipboard, clipboard->response_data_event,
                        &clipboard->hmem);
}

UINT cliprdr_send_request_filecontents(wfClipboard *clipboard, UINT32 connID,
                                       const void *streamid, ULONG index,
                                       UINT32 flag, DWORD positionhigh,
...
static LRESULT CALLBACK cliprdr_proc(HWND hWnd, UINT Msg, WPARAM wParam,
    ...
    case WM_CLIPRDR_MESSAGE:
        ...
        case OLE_SETCLIPBOARD:
            ...
            if (WaitForSingleObject(clipboard->data_obj_mutex, INFINITE) !=
                WAIT_OBJECT_0) {
                break;
            }
            ...
            if (wf_create_file_obj((UINT32 *)lParam, clipboard,
                                   &clipboard->data_obj)) {
        ...
        case DELAYED_RENDERING:
            ...
            for (UINT32 i = 0; i < format_ids->size; ++i) {
                if (cliprdr_send_data_request(format_ids->connID, clipboard,
                                              format_ids->formats[i]) != 0) {
                    DEBUG_CLIPRDR("error: cliprdr_send_data_request failed.");
                    continue;
                }

                if (!SetClipboardData(format_ids->formats[i],
                                      clipboard->hmem)) {
...
static int create_cliprdr_window(wfClipboard *clipboard) {
    ...
    clipboard->hwnd = CreateWindowEx(
        WS_EX_LEFT, _T("ClipboardHiddenMessageProcessor"), _T("rdpclip"), 0, 0,
        0, 0, 0, HWND_MESSAGE, NULL, GetModuleHandle(NULL), clipboard);
...
static BOOL wf_cliprdr_array_ensure_capacity(wfClipboard *clipboard) {
    ...
    if (clipboard->nFiles == clipboard->file_array_size) {
        ...
        new_fd = (FILEDESCRIPTORW **)realloc(
            clipboard->fileDescriptor, new_size * sizeof(FILEDESCRIPTORW *));

        if (new_fd)
            clipboard->fileDescriptor = new_fd;

        new_name = (WCHAR **)realloc(clipboard->file_names,
...
static BOOL wf_cliprdr_add_to_file_arrays(wfClipboard *clipboard,
    ...
    wcscpy_s(clipboard->file_names[clipboard->nFiles], MAX_PATH,
             full_file_name);
...
static BOOL wf_cliprdr_traverse_directory(wfClipboard *clipboard, WCHAR *Dir,
                                          size_t pathLen) {
    HANDLE hFind;
 ...
 */
static UINT
wf_cliprdr_monitor_ready(CliprdrClientContext *context,
 ...
 */
static UINT
wf_cliprdr_server_capabilities(CliprdrClientContext *context,
 ...
 */
static UINT
wf_cliprdr_server_format_list(CliprdrClientContext *context,
    ...
    for (i = 0; i < formatList->numFormats; i++) {
        ...
        if (format->formatName) {
            ...
            if (mapping->name) {
                MultiByteToWideChar(CP_UTF8, 0, format->formatName,
                                    strlen(format->formatName), mapping->name,
                                    size);
                mapping->local_format_id =
                    RegisterClipboardFormatW((LPWSTR)mapping->name);
            }
        } else {
            mapping->name = NULL;
    ...
    if (file_transferring(clipboard)) {
        ...
        if (context->EnableOthers) {
            ...
            if (EmptyClipboard()) {
                ...
                //    SetClipboardData(clipboard->format_mappings[i].local_format_id,
                //    NULL);

                FORMAT_IDS *format_ids =
                    (FORMAT_IDS *)calloc(1, sizeof(FORMAT_IDS));
                format_ids->connID = formatList->connID;
                format_ids->size = (UINT32)clipboard->map_size;
                format_ids->formats =
                    (UINT32 *)calloc(format_ids->size, sizeof(UINT32));
                for (i = 0; i < format_ids->size; ++i) {
                    format_ids->formats[i] =
                        clipboard->format_mappings[i].local_format_id;
                }
                if (PostMessage(clipboard->hwnd, WM_CLIPRDR_MESSAGE,
                                DELAYED_RENDERING, format_ids)) {
                    rc = CHANNEL_RC_OK;
                } else {
                    rc = ERROR_INTERNAL_ERROR;
                }
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT wf_cliprdr_server_format_list_response(
    CliprdrClientContext *context,
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT wf_cliprdr_server_lock_clipboard_data(
    CliprdrClientContext *context,
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT wf_cliprdr_server_unlock_clipboard_data(
    CliprdrClientContext *context,
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT wf_cliprdr_server_format_data_request(
    CliprdrClientContext *context,
    ...
    if (requestedFormatId == RegisterClipboardFormat(CFSTR_FILEDESCRIPTORW)) {
        ...
        if (dropFiles->fWide) {
            ...
            for (wFileName = (WCHAR *)((char *)dropFiles + dropFiles->pFiles);
                ...
                wf_cliprdr_process_filename(clipboard, wFileName,
                                            wcslen(wFileName));
            }
        } else {
            char *p;
            for (p = (char *)((char *)dropFiles + dropFiles->pFiles);
                ...
                WCHAR *wFileName;
                cchWideChar =
                    MultiByteToWideChar(CP_ACP, MB_COMPOSITE, p, len, NULL, 0);
                wFileName = (LPWSTR)calloc(cchWideChar, sizeof(WCHAR));
                MultiByteToWideChar(CP_ACP, MB_COMPOSITE, p, len, wFileName,
                                    cchWideChar);
...
exit:
    ...
    if (ERROR_SUCCESS != clipboard->context->ClientFormatDataResponse(
                             clipboard->context, &response)) {
...
static UINT wf_cliprdr_server_format_data_response(
    ...
    do {
        ...
        if (formatDataResponse->msgFlags != CB_RESPONSE_OK) {
            // BOOL emptyRes = wf_do_empty_cliprdr((wfClipboard
            // *)context->custom); (void)emptyRes;
            rc = E_FAIL;
            break;
        }
    ...
    if (!SetEvent(clipboard->response_data_event)) {
        // CAUTION: critical error here, process will hang up until wait timeout
        // default 3min.
        rc = ERROR_INTERNAL_ERROR;
    }
    return rc;
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT wf_cliprdr_server_file_contents_request(
    CliprdrClientContext *context,
    ...
    if ((uStreamIdStc != fileContentsRequest->streamId) || !pStreamStc) {
        ...
        bIsStreamFile = FALSE;
        hRet =
            IDataObject_EnumFormatEtc(pDataObj, DATADIR_GET, &pEnumFormatEtc);

        if (hRet == S_OK) {
            do {
                hRet = IEnumFORMATETC_Next(pEnumFormatEtc, 1, &vFormatEtc2,
                                           &CeltFetched);

                if (hRet == S_OK) {
                    if (vFormatEtc2.cfFormat ==
                        RegisterClipboardFormat(CFSTR_FILECONTENTS)) {
                        hRet = IDataObject_GetData(pDataObj, &vFormatEtc,
                                                   &vStgMedium);
    ...
    if (bIsStreamFile == TRUE) {
        if (fileContentsRequest->dwFlags == FILECONTENTS_SIZE) {
            ...
            hRet = IStream_Seek(pStreamStc, dlibMove, STREAM_SEEK_SET,
                                &dlibNewPosition);
        ...
        if (fileContentsRequest->dwFlags == FILECONTENTS_SIZE) {
            ...
            *((UINT32 *)&pData[0]) =
                clipboard->fileDescriptor[fileContentsRequest->listIndex]
                    ->nFileSizeLow;
            *((UINT32 *)&pData[4]) =
                clipboard->fileDescriptor[fileContentsRequest->listIndex]
                    ->nFileSizeHigh;
            ...
            bRet = wf_cliprdr_get_file_contents(
                ...
                fileContentsRequest->nPositionHigh, cbRequested, &uSize);
...
exit:
    ...
    sRc = cliprdr_send_response_filecontents(
        clipboard, fileContentsRequest->connID,
        rc == CHANNEL_RC_OK ? CB_RESPONSE_OK : CB_RESPONSE_FAIL,
        fileContentsRequest->streamId, uSize, pData);
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
static UINT wf_cliprdr_server_file_contents_response(
    CliprdrClientContext *context,
...
BOOL wf_cliprdr_init(wfClipboard *clipboard, CliprdrClientContext *cliprdr) {
    ...
    if (!(clipboard->format_mappings = (formatMapping *)calloc(
              clipboard->map_capacity, sizeof(formatMapping))))
        goto error;
    ...
    if (!(clipboard->data_obj_mutex =
              CreateMutex(NULL, FALSE, "data_obj_mutex")))
        goto error;
    ...
    if (!(clipboard->thread =
              CreateThread(NULL, 0, cliprdr_thread_func, clipboard, 0, NULL)))
        goto error;
